...

{
    ...
    // reading highscore from existing file
    ...
    while (!WindowShouldClose())
    {
        ...
        // aiming, pulling back and shooting of arrow (arrow and bow can rotate)
        ...
        // projectile formula for arrow in air
        ...
        if (gameover == false)
        {
            ...
            if (currentspawntimer >= spawninterval)
            {
                ...
                for (int i = 0; i < MAXBALLOONS; i++)
                {
                    ...
                    {
                        balloons[i].position = spawnholes[GetRandomValue(0, 4)];
        ...
        // floating of balloons and collision mech of balloon with arrow
        for (int i = 0; i < MAXBALLOONS; i++)
        {
            if (balloons[i].active == false)
                continue;
        ...
        // game over and comparing score with highscore
        ...
        // drawing bow string
        Vector2 bowstringtop = Vector2Add(arrowpivot, Vector2Rotate((Vector2){0.0, 95.0f}, aimangle));
        ...
        // drawing arrow in air OR at bow
        ...
        // drawing balloons (special or normal)
        for (int i = 0; i < MAXBALLOONS; i++)
        {
